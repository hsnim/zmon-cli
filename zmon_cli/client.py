...
class ZmonArgumentError(ZmonError):
    """A ZMON client error indicating that supplied object has missing or invalid attributes."""
    pass
...
class Zmon:
    ...
    def __init__(
        ...
        :param user_agent: ZMON user agent. Default is generated by ZMON client including lib version.
        :type user_agent: str
        """
...
########################################################################################################################
    ...
    def get_onetime_token(self):
        ...
        You can use :func:`token_login_url` to return a deeplink to one-time login.
